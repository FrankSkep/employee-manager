...
public:
    EmpleadoPorComision(const std::string &nombre, const std::string &apellido, int edad, double salarioBase, int semanasAnuales, double montoVentas, double porcentajeComision);
    EmpleadoPorComision(int numeroEmpleado, const std::string &nombre, const std::string &apellido, int edad, double salarioBase, int semanasAnuales, double montoVentas, double porcentajeComision);
